...
#define USE_JSON                    (false)   // use ajson library for json response

#define USE_SENSOR_ADT              (false)   // ADT7420
#define USE_SENSOR_HIH              (false)   // HIH6100
#define USE_SENSOR_HYT              (true)   // HYT271
...
#define USE_SENSOR_ITH              (false)   // Temperature and humidity continuous istantaneous
#define USE_SENSOR_MTH              (false)   // Temperature and humidity continuous average
#define USE_SENSOR_NTH              (false)   // Temperature and humidity continuous minium
#define USE_SENSOR_XTH              (false)   // Temperature and humidity continuous maximum
...
#define REPORT_MINUTES              (2) // every 5-60 minutes (minutes for report. > n * OBSERVATIONS_MINUTES)
